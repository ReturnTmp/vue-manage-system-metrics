            ...
            <el-collapse @change="handleChange">
                <el-collapse-item title="HELP" name="1">
                    <div>
                        ...
                        <ol>
                            <li>
                                <strong>类的加权方法数 (WMC):</strong> 一个较高的WMC值表明类可能过于复杂，难以理解和测试。通常认为，WMC超过20可能是一个警示信号，但这取决于方法的实际复杂度。
                            </li>
                            <li>
                                <strong>深度继承树 (DIT):</strong> DIT值过高（例如，超过5）可能表明过度的继承，这可能导致代码难以理解和维护。
                            </li>
                            <li>
                                <strong>子类数量 (NOC):</strong> 较高的NOC值（如超过10）可能表示类的职责过多，可能需要进一步分解。
                            </li>
                            <li>
                                <strong>耦合程度 (CBO):</strong> CBO值超过10通常被视为高耦合，应考虑降低耦合。
                            </li>
                            <li>
                                <strong>响应集 (RFC):</strong> 如果RFC超过50，可能表明类与系统的其他部分交互过于频繁，可能需要重新设计接口。
                            </li>
                            <li>
                                <strong>缺乏内聚力 (LCOM):</strong> LCOM较高（接近1）意味着类中的方法几乎没有共享数据，类的内聚性差，可能需要重构。
                            </li>
                        </ol>
                        <h2>LK度量阈值建议</h2>
                        <ul>
                            <li>
                                <strong>CS（类大小）:</strong> 通常认为，一个类的代码行数不应超过几百行，具体数字可能因语言和项目类型而异。例如，超过200行可能需要审查和可能的重构。
                            </li>
                            <li>
                                <strong>NOO（操作重载度）:</strong> 较高的NOO可能表明过度使用继承，如果NOO接近父类的操作总数，可能表明设计上的问题。
                            </li>
                            <li>
                                <strong>NOA（属性数）:</strong> 属性数量过多（例如超过10-15）可能表明类的职责过于庞大，考虑是否违反了单一职责原则。
                            </li>
                            <li>
                                <strong>SI（专用性指数）:</strong> 没有固定的好坏标准，但是一个较高的SI值需要特别关注，因为它可能表明类的设计高度依赖继承。
                            </li>
                        </ul>
                    </div>
